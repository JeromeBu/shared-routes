...
var defineRoute = function (route) { return (__assign({ bodySchema: zod_1.z.object({}).strict(), queryParamsSchema: zod_1.z.object({}).strict(), responseBodySchema: zod_1.z.void(), headersSchema: zod_1.z.object({}) }, route)); };
