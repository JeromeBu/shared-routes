...
var defineRoute = function (route) { return (__assign({ requestBodySchema: zod_1.z.object({}).strict(), queryParamsSchema: zod_1.z.object({}).strict(), responses: { 201: zod_1.z.void() }, headersSchema: zod_1.z.object({}) }, route)); };
