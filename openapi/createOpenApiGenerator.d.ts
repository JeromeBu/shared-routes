...
import { z } from "zod";
import { PathParameters, UnknownSharedRoute } from "..";
...
type CreateOpenApiGenerator = <SharedRoutesByTag extends {
    ...
    [Tag in keyof SharedRoutesByTag]: {
        [R in keyof SharedRoutesByTag[Tag]]: OmitFromExisting<OpenAPI.OperationObject, "parameters" | "responses" | "requestBody"> & {
            extraDocs: {
