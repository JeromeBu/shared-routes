...
var createOpenApiGenerator = function (sharedRoutes, openApiRootDoc) { return function (extraDataByRoute) { return (__assign(__assign({}, openApiRootDoc), { paths: (0, core_1.keys)(sharedRoutes).reduce(function (acc, routeName) {
        var _a, _b;
        var _c;
...
var zodToOpenApi = function (schema) {
    var _a = (0, zod_to_json_schema_1.default)(schema), $schema = _a.$schema, rest = __rest(_a, ["$schema"]);
    return rest;
};
