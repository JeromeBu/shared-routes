...
var createOpenApiGenerator = function (sharedRoutes, openApiRootDoc) { return function (extraDataByRoute) { return (__assign(__assign({}, openApiRootDoc), { paths: (0, __1.keys)(sharedRoutes).reduce(function (acc, routeName) {
        var _a, _b, _c;
        var _d, _e;
        var route = sharedRoutes[routeName];
        var _f = (_d = extraDataByRoute[routeName]) !== null && _d !== void 0 ? _d : {}, extraDocs = _f.extraDocs, extraDataForRoute = __rest(_f, ["extraDocs"]);
        var responseSchema = zodToOpenApi(route.responseBodySchema);
        var responseSchemaType = responseSchema.type;
        var _g = extractFromUrl(route.url), formattedUrl = _g.formattedUrl, pathParams = _g.pathParams;
        ...
        })), { responses: __assign((_c = {}, _c[(_e = extraDocs === null || extraDocs === void 0 ? void 0 : extraDocs.successStatusCode) !== null && _e !== void 0 ? _e : 200] = __assign(__assign({ description: responseSchemaType !== undefined
                    ? "Success"
