...
var getTimeoutUtils = function (timeoutDurationMs) {
    ...
    var timeoutId = setTimeout(function () { return controller.abort(); }, timeoutDurationMs);
                    ...
                    switch (_e.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, fetch((baseURL ? baseURL : "") +
                                    ...
                                    stringQueryParams, __assign(__assign(__assign(__assign({ signal: signal }, defaultInit), { method: route.method.toUpperCase() }), (bodyAsString !== "{}" ? { body: bodyAsString } : {})), { headers: headersToSend }))];
                        case 1:
                            res = _e.sent();
                            cleanup();
