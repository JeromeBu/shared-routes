    ...
    return function (routeName, routes, replaceParamsInUrl) {
        return function (_a) {
            ...
            return __awaiter(void 0, void 0, void 0, function () {
                var route, _b, body, headers, queryParams, bodyAsString, stringQueryParams, baseURL, defaultInit, res, json, responseBody;
                    ...
                    switch (_c.label) {
                        case 0:
                            ...
                            _b = options.skipInputValidation
                                ? params
                                : (0, validations_1.validateInputParams)(route, params, "fetch"), body = _b.body, headers = _b.headers, queryParams = _b.queryParams;
                        ...
                        case 2:
                            ...
                            responseBody = options.skipResponseValidation
                                ? json
                                : (0, validations_1.validateSchemaWithExplictError)({
                                    adapterName: "fetch",
                            ...
                            return [2 /*return*/, { body: responseBody, status: res.status }];
                    }
                });
            });
        };
