    ...
    return function (routeName, routes, replaceParamsInUrl) {
        return function () {
            ...
            return __awaiter(void 0, __spreadArray([], __read(args_1), false), void 0, function (_a) {
                var route, _b, body, headers, queryParams, stringQueryParams, baseURL, defaultInit, headersToSend, bodyAsString, queryStartTime, res, headersAsObject, processedBody, responseBody;
                var _c;
                if (_a === void 0) { _a = {}; }
                    ...
                    switch (_d.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, fetch((baseURL ? baseURL : "") +
                                    ...
                                    stringQueryParams, __assign(__assign(__assign(__assign({}, defaultInit), { method: route.method.toUpperCase() }), (bodyAsString !== "{}" ? { body: bodyAsString } : {})), { headers: headersToSend }))];
                        case 1:
                            res = _d.sent();
