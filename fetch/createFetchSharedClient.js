...
exports.createFetchSharedClient = exports.createFetchHandlerCreator = exports.makeBodyToSend = void 0;
var __1 = require("..");
var validations_1 = require("../validations");
var convertToFormData_1 = require("./convertToFormData");
...
var makeBodyToSend = function (body, contentType) {
    if (!body || Object.keys(body).length === 0) {
        return undefined;
    }
    switch (contentType) {
        case "application/x-www-form-urlencoded":
            return (0, convertToFormData_1.convertToFormData)(body);
        case "application/json":
        default:
            return JSON.stringify(body);
    }
};
exports.makeBodyToSend = makeBodyToSend;
var getTimeoutUtils = function (timeoutDurationMs) {
    ...
    var timeoutId = setTimeout(function () { return controller.abort(new Error("timeout of ".concat(timeoutDurationMs, "ms exceeded"))); }, timeoutDurationMs);
    return { cleanup: function () { return clearTimeout(timeoutId); }, signal: signal };
};
    ...
    return function (routeName, routes, replaceParamsInUrl) {
        return function () {
            ...
            return __awaiter(void 0, __spreadArray([], __read(args_1), false), void 0, function (_a) {
                var route, _b, body, headers, queryParams, stringQueryParams, baseURL, timeout, defaultInit, headersToSend, bodyAsString, queryStartTime, _c, signal, cleanup, res, headersAsObject, processedBody, responseBody;
                var _d;
                if (_a === void 0) { _a = {}; }
                    ...
                    switch (_e.label) {
                        case 0:
                            ...
                            stringQueryParams = queryParams && Object.keys(queryParams).length > 0
                                ? "?" + (0, convertToFormData_1.convertToFormData)(queryParams)
                                : "";
                            baseURL = options.baseURL, timeout = options.timeout, defaultInit = __rest(options, ["baseURL", "timeout"]);
                            ...
                            bodyAsString = (0, exports.makeBodyToSend)(body, headersToSend["Content-Type"]);
                            queryStartTime = Date.now();
                            _c = getTimeoutUtils(timeout), signal = _c.signal, cleanup = _c.cleanup;
                            return [4 /*yield*/, fetch((baseURL ? baseURL : "") +
                                    replaceParamsInUrl(route.url, urlParams) +
                                    stringQueryParams, __assign(__assign(__assign(__assign({ signal: signal }, defaultInit), { method: route.method.toUpperCase() }), (bodyAsString !== "{}" ? { body: bodyAsString } : {})), { headers: headersToSend })).catch(function (e) {
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, responseTypeToResponseBody(res)];
                        case 2:
                            processedBody = _e.sent();
                            if (options === null || options === void 0 ? void 0 : options.onResponseSideEffect) {
                                options.onResponseSideEffect({
                                    response: {
                                        status: res.status,
                            ...
                            responseBody = (options === null || options === void 0 ? void 0 : options.skipResponseValidation) ||
                                ((_d = options === null || options === void 0 ? void 0 : options.skipResponseValidationForStatuses) === null || _d === void 0 ? void 0 : _d.includes(res.status))
                                ? processedBody
...
var responseTypeToResponseBody = function (res) {
    var _a;
    var contentType = ((_a = res.headers.get("content-type")) === null || _a === void 0 ? void 0 : _a.toLowerCase()) || "";
