    ...
    return function (routeName, routes, replaceParamsInUrl) {
        return function (_a) {
            ...
            return __awaiter(void 0, void 0, void 0, function () {
                var route, _b, body, headers, queryParams, _c, data, status, rest, responseBody;
                    ...
                    switch (_d.label) {
                        case 0:
                            ...
                            _b = (options === null || options === void 0 ? void 0 : options.skipInputValidation)
                                ? params
                                : (0, validations_1.validateInputParams)(route, params, "axios"), body = _b.body, headers = _b.headers, queryParams = _b.queryParams;
                        ...
                        case 1:
                            _c = _d.sent(), data = _c.data, status = _c.status, rest = __rest(_c, ["data", "status"]);
