...
export var createFetchHandlerCreator = function (fetch, _a) {
                    ...
                    switch (_c.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, fetch((baseURL ? baseURL : "") +
                                    ...
                                    stringQueryParams, __assign(__assign({ method: route.method }, (body ? { body: JSON.stringify(body) } : {})), { headers: __assign({ "Content-Type": "application/json" }, (headers !== null && headers !== void 0 ? headers : {})) }))];
                        case 1:
                            res = _c.sent();
