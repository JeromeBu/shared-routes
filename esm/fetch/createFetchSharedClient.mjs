    ...
    return function (routeName, routes, replaceParamsInUrl) {
        return function () {
            ...
            return __awaiter(void 0, __spreadArray([], __read(args_1), false), void 0, function (_a) {
                var route, _b, body, headers, queryParams, bodyAsString, stringQueryParams, baseURL, defaultInit, queryStartTime, res, processedBody, headersAsObject, responseBody;
                var _c;
                if (_a === void 0) { _a = {}; }
