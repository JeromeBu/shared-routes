import type { HandlerOutputParams, HttpResponse } from "./configureCreateHttpClient.mjs";
...
export declare const validateInputParams: (route: UnknownSharedRoute, params: HandlerOutputParams<UnknownSharedRoute>, adapterName: string, options?: {
    withIssuesInMessage: boolean;
}) => {
