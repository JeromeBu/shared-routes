...
import { z } from "zod";
export var defineRoute = function (route) { return (__assign({ bodySchema: z.object({}).strict(), queryParamsSchema: z.object({}).strict(), responseBodySchema: z.void(), headersSchema: z.object({}) }, route)); };
