...
import { z } from "zod";
export var defineRoute = function (route) { return (__assign({ requestBodySchema: z.object({}).strict(), queryParamsSchema: z.object({}).strict(), responseBodySchema: z.void(), headersSchema: z.object({}) }, route)); };
