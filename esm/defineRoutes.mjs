...
import { z } from "zod";
export var defineRoute = function (route) { return (__assign({ requestBodySchema: z.object({}).strict(), queryParamsSchema: z.object({}).strict(), responses: { 201: z.void().or(z.string().max(0)) }, headersSchema: z.object({}) }, route)); };
