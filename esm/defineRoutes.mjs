...
import { z } from "zod";
export var defineRoute = function (route) { return (__assign({ requestBodySchema: z.object({}).strict(), queryParamsSchema: z.object({}).strict(), responses: { 201: z.void() }, headersSchema: z.object({}) }, route)); };
