...
exports.validateInputParams = exports.validateSchemaWithExplicitError = void 0;
var standardSchemaUtils_1 = require("./standardSchemaUtils");
...
var validateSchemaWithExplicitError = function (_a) {
    ...
    if (checkedSchema === "responses") {
        ...
        var result_1 = (0, standardSchemaUtils_1.standardValidate)(schema, params);
        if (!result_1.issues)
    ...
    var result = (0, standardSchemaUtils_1.standardValidate)(route[checkedSchema], params);
    if (!result.issues)
        return result.value;
    throw explicitError({
...
exports.validateSchemaWithExplicitError = validateSchemaWithExplicitError;
var validateInputParams = function (route, params, adapterName, options) {
    if (options === void 0) { options = {
        withIssuesInMessage: false,
    }; }
    var withIssuesInMessage = options.withIssuesInMessage;
    var queryParams = (0, exports.validateSchemaWithExplicitError)({
        adapterName: adapterName,
    ...
    var body = (0, exports.validateSchemaWithExplicitError)({
        adapterName: adapterName,
    ...
    (0, exports.validateSchemaWithExplicitError)({
        adapterName: adapterName,
