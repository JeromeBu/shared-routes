...
var myRoutes = (0, src_1.defineRoutes)({
...
var createTestHttpClient = function () {
    var books = [];
    return (0, src_1.createCustomSharedClient)(myRoutes, {
...
(0, vitest_1.describe)("createCustomSharedClient", function () {
    (0, vitest_1.it)("all routes work fine", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    (0, vitest_1.expect)(response.body).toBe(undefined);
                    return [4 /*yield*/, httpClient.getAllBooks({
                            queryParams: { max: 12 },
                        })];
                case 2:
                    allBooks = (_a.sent()).body;
                    (0, vitest_1.expect)(allBooks).toEqual([myBook]);
                    return [4 /*yield*/, httpClient.getByTitle({
                            urlParams: { title: "potter" },
                        })];
                case 3:
                    fetchedBook = (_a.sent()).body;
                    (0, vitest_1.expect)(fetchedBook).toEqual(myBook);
                    return [2 /*return*/];
            }
        });
    }); });
});
//# sourceMappingURL=createCustomSharedClient.test.js.map