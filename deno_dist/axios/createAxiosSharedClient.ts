import type { AxiosInstance } from "npm:axios@0.26.1";
import type { UnknownSharedRoute, Url } from "../core/index.ts";
import { configureCreateHttpClient, HandlerCreator } from "../core/index.ts";
