        ...
        return function (_a) {
            ...
            return __awaiter(void 0, void 0, void 0, function () {
                return __generator(this, function (_c) {
                    return [2 /*return*/, supertestRequestToCorrectHttpMethod(supertestRequest, route.method)(replaceParamsInUrl(route.url, urlParams))
                            .send(body)
...
var createSupertestSharedClient = function (sharedRoutes, supertestRequest) {
    return (0, core_1.configureCreateHttpClient)((0, exports.createSupertestHandlerCreator)(supertestRequest))(sharedRoutes);
};
