        ...
        return function (_a) {
            ...
            return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0: return [4 /*yield*/, supertestRequestToCorrectHttpMethod(supertestRequest, route.method)(replaceParamsInUrl(route.url, urlParams))
                                .send(body)
                                .set(headers !== null && headers !== void 0 ? headers : {})
                                .query(queryParams)];
                        case 1:
                            result = _c.sent();
                            return [2 /*return*/, __assign({ status: result.status, body: result.body }, (!Object.keys(route.responses).includes(result.status.toString()) && {
                                    text: result.text,
                                }))];
                    }
                });
